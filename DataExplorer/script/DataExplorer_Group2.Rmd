...
If you would like to see the distribution of another discrete column within the bars, you can add by = "column". This will essentially create stacked columns with color mapped to that specified column. Let's also add a ggplot2 theme. 
